...
@EnableJpaRepositories(basePackages = "com.ipostu.demo14.multipledatasources.repositories.creditcard",
...
public class CardDatabaseConfiguration {
    ...
    public DataSource
        cardDataSource(@Qualifier("cardDataSourceProperties") DataSourceProperties cardDataSourceProperties) {
