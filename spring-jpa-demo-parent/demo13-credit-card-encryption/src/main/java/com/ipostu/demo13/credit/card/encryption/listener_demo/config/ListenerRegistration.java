package com.ipostu.demo13.credit.card.encryption.listener_demo.config;

import com.ipostu.demo13.credit.card.encryption.listener_demo.listeners.PostLoadListener;
import com.ipostu.demo13.credit.card.encryption.listener_demo.listeners.PreInsertListener;
import com.ipostu.demo13.credit.card.encryption.listener_demo.listeners.PreUpdateListener;
...
public class ListenerRegistration implements BeanPostProcessor {
    ...
    public ListenerRegistration(PostLoadListener postLoadListener, PreInsertListener preInsertListener,
